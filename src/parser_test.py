...
class TestParser(unittest.TestCase):
    def test_jan_2018(self):
        ...
        files = ["src/output_test/sheets/membros-ativos-contracheque-01-2018.csv"]
    ...
    def test_jul_2019(self):
        ...
        files = [
            "src/output_test/sheets/membros-ativos-contracheque-07-2019.csv",
            "src/output_test/sheets/membros-ativos-verbas-indenizatorias-07-2019.csv",
        ]
